...
Optionally, users can create a virtual environment using [mamba](https://mamba.readthedocs.io/en/latest/user_guide/mamba.html) or [python venv](https://docs.python.org/3/library/venv.html) before installing **fimep**.
...
1. **Single workflow** (`runall`): Complete analysis from raw tool outputs to final predictions
2. **Step-by-step**: Individual steps for more control over the process


### Single workflow usage

Users should type in each line into the command line as copying and pasting directly might cause error. 
...
For issues, questions or contributions, please open an issue on the [GitHub repository](https://github.com/LoveBio/fimep/issues) or reach out via [mail](mailto:lovekayode1@gmail.com).
