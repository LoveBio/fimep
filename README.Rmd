...
1. [Extract predicted effectors as a fasta file for other downstream analysis](https://github.com/LoveBio/fimep/blob/master/Extract-effectors.md)
...
For issues, questions or contributions, please open an issue on the [GitHub repository](https://github.com/LoveBio/fimep/issues) or contact us via [email](mailto:lovekayode1@gmail.com).
